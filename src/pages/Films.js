      ...
      >
        <div className={`modal-dialog modal-dialog-centered`}>
          <div className={`modal-content ${styles.modalContent}`}>
            <img src="./ficon.png" alt="ficon" className={styles.ficon} style={{ backgroundColor: "white" }}></img>
      ...
      <div className={styles.titleBar}>
        ...
        <div className={styles.displayButton}>
          <div onClick={setGrid} style={isGrid ? { backgroundColor: 'white', color: 'gray' } : { backgroundColor: 'transparent' }}>
            <img src="./fourdot.png" alt="fourdot" style={isGrid ? { backgroundColor: "white" } : { backgroundColor: 'transparent' }}></img>
          ...
          <div onClick={setTable} style={!isGrid ? { backgroundColor: 'white', color: 'gray' } : { backgroundColor: 'transparent' }}>
            <img src="./ham.png" alt="ham"style={{ backgroundColor: "transparent" }}></img>
            ...
            {data &&
              data.map((curr, index) => {
                return (
                  <tr>
                    <td>
                      <img className={styles.reel} src="./reel.png" alt="reel"></img>
                      {curr.title}
                    </td>
                    <td>{curr.director}</td>
